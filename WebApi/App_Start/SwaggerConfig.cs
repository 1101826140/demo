...
namespace WebApi
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.IncludeXmlComments(Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, @"bin\WebApi.XML"));


                        //string path = string.Format("{0}/bin/WebApi1.XML", System.AppDomain.CurrentDomain.BaseDirectory);
                        //c.IncludeXmlComments(path);
                        //path = string.Format("{0}/bin/WebApi2.XML", System.AppDomain.CurrentDomain.BaseDirectory);
                        //c.IncludeXmlComments(path);
                        //path = string.Format("{0}/bin/WebApi3.XML", System.AppDomain.CurrentDomain.BaseDirectory);
                        //c.IncludeXmlComments(path);
    ...
    public class SwaggerVersionHelper
    {
        public static bool ResolveVersionSupportByRouteConstraint(ApiDescription apiDesc, string targetApiVersion)
        {
            ...
            if (apiDesc.ActionDescriptor.ControllerDescriptor.GetCustomAttributes<VersionedRoute>().Count == 0)
            {
                return false;
            }
            ...
            return attr.Version == Convert.ToInt32(targetApiVersion.ToLower().TrimStart('v'));
        }
    }
